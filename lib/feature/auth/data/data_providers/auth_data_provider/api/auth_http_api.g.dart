...
class _AuthHttpApi implements AuthHttpApi {
  _AuthHttpApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<void> register({required AuthRegisterRequestDTO body}) async {
